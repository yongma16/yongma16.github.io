...
function rebindTarget2Fn(target, fn) {
  ...
  if ((0, _utils.isCallable)(fn) && !(0, _utils.isBoundedFunction)(fn) && !(0, _utils.isConstructable)(fn)) {
    ...
    var boundValue = Function.prototype.bind.call(fn, target); // some callable function has custom fields, we need to copy the own props to boundValue. such as moment function.
