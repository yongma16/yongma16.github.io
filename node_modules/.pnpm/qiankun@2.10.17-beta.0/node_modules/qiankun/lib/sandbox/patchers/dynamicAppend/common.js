        ...
        case STYLE_TAG_NAME:
          {
            ...
            var result = rawDOMAppendOrInsertBefore.call(mountDOM, stylesheetElement, referenceNode); // record refNo thus we can keep order while remounting
        ...
        case SCRIPT_TAG_NAME:
          {
            var _element = element,
                src = _element.src,
                text = _element.text; // some script like jsonp maybe not support cors which shouldn't use execScripts
            ...
            if (src) {
              ...
              (0, _importHtmlEntry.execScripts)(null, [src], proxy, {
                ...
                beforeExec: function beforeExec() {
                  resetCurrentScript = (0, _utils.patchCurrentScript)(element);
                },
...
function patchHTMLDynamicAppendPrototypeFunctions(isInvokedByMicroApp, containerConfigGetter) {
  ...
  var rawHeadInsertBefore = HTMLHeadElement.prototype.insertBefore; // Just overwrite it while it have not been overwritten
  ...
  var rawBodyRemoveChild = HTMLBodyElement.prototype.removeChild; // Just overwrite it while it have not been overwritten
