...
var removeCacheListener = function removeCacheListener(listenerMap, type, rawListener, rawOptions) {
  ...
  // 处理 options，确保它是一个对象
  var options = (0, _typeof2.default)(rawOptions) === 'object' ? rawOptions : {
    capture: !!rawOptions
...
var addCacheListener = function addCacheListener(listenerMap, type, rawListener, rawOptions) {
  ...
  listenerMap.set(type, [].concat((0, _toConsumableArray2.default)(cachedTypeListeners), [cacheListener]));
  return cacheListener;
};
...
function patch(global) {
  ...
  return function free() {
    listenerMap.forEach(function (listeners, type) {
      return (0, _toConsumableArray2.default)(listeners).forEach(function (_ref) {
