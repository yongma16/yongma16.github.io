...
export declare function patchCurrentScript(currentScript: HTMLScriptElement | null): () => void;
export declare function createFakeCurrentScript(scriptUrl: string): HTMLScriptElement | null;
