...
exports.isPersistentCachingEnabled = isPersistentCachingEnabled;
exports.normalizeTurbopackMemoryEviction = normalizeTurbopackMemoryEviction;
function isTruthyEnv(value) {
    return value === "1" || value === "true";
}
function isPersistentCachingEnabled(configuredValue) {
    var _a;
    return (!isTruthyEnv((_a = process.env.DISABLE_PERSISTENT_CACHE) === null || _a === void 0 ? void 0 : _a.toLowerCase()) &&
        (configuredValue !== null && configuredValue !== void 0 ? configuredValue : true));
}
