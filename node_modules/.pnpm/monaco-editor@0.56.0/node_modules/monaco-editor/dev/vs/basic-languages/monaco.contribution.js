define("vs/basic-languages/monaco.contribution", ["require", "../editor-ECyZhXSU"], (function(require, editor) {
  "use strict";
  ...
  function registerLanguage(def) {
    ...
    editor.languages.register(def);
    const lazyLanguageLoader = LazyLanguageLoader.getOrCreate(languageId);
    editor.languages.registerTokensProviderFactory(languageId, {
      create: async () => {
        const mod = await lazyLanguageLoader.load();
        return mod.language;
      }
    });
    editor.languages.onLanguageEncountered(languageId, async () => {
      const mod = await lazyLanguageLoader.load();
      editor.languages.setLanguageConfiguration(languageId, mod.conf);
    });
  }
  registerLanguage({
    id: "abap",
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagAutoInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagAngleInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagBracketInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagAngleInterpolationBracket);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagBracketInterpolationBracket);
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-Bx7HBW3p"], resolve, reject)).then((m) => m.TagAutoInterpolationBracket);
    }
  });
  registerLanguage({
    id: "go",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../handlebars-tpDpshxD"], resolve, reject))
  });
  registerLanguage({
    id: "hcl",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../html-DRolYhT1"], resolve, reject))
  });
  registerLanguage({
    id: "ini",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../javascript-C1ke7AmN"], resolve, reject))
  });
  registerLanguage({
    id: "julia",
    extensions: [".jl"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../liquid-wuL5iTXo"], resolve, reject))
  });
  registerLanguage({
    id: "m3",
  ...
  registerLanguage({
    ...
    extensions: [".mdx"],
    aliases: ["MDX", "mdx"],
    loader: () => new Promise((resolve, reject) => require(["../mdx-C09uLMiS"], resolve, reject))
  });
  registerLanguage({
    id: "mips",
    extensions: [".s"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../python-DJO4EydL"], resolve, reject))
  });
  registerLanguage({
    id: "qsharp",
    extensions: [".qs"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../razor-CyjqIeeY"], resolve, reject))
  });
  registerLanguage({
    id: "redis",
    extensions: [".redis"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../swift-DsQnGmoS"], resolve, reject))
  });
  registerLanguage({
    id: "systemverilog",
    extensions: [".sv", ".svh"],
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../typescript-C91qw6Kb"], resolve, reject));
    }
  });
  registerLanguage({
    id: "typespec",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../xml-if6RvW7B"], resolve, reject))
  });
  registerLanguage({
    id: "yaml",
    extensions: [".yaml", ".yml"],
    ...
    loader: () => new Promise((resolve, reject) => require(["../yaml-fV1UC1UZ"], resolve, reject))
  });
}));
