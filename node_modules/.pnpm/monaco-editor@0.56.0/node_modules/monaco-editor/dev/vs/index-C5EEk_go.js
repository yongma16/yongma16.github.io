define("vs/index-C5EEk_go", ["exports", "./editor-ECyZhXSU", "./toggleHighContrast-LEuD8lYt", "./basic-languages/monaco.contribution", "./monaco.contribution-CZhNs2WM", "./monaco.contribution-DPdiidye", "./monaco.contribution-BGIsXway", "./monaco.contribution-Bj7ZDQQk"], (function(exports, editor, toggleHighContrast, src_deprecated_basicLanguages_monaco_contribution_ts, src_deprecated_language_css_monaco_contribution_ts, src_deprecated_language_html_monaco_contribution_ts, src_deprecated_language_json_monaco_contribution_ts, src_deprecated_language_typescript_monaco_contribution_ts) {
  "use strict";
  ...
  const OptionalMethodNotFound = /* @__PURE__ */ Symbol("OptionalMethodNotFound");
...
${JSON.stringify(response, null, 2)}`);
  ...
  const IsErrorWrapper = /* @__PURE__ */ Symbol();
  ...
  const monacoCodeActionTriggerTypeToLspCodeActionTriggerKind = /* @__PURE__ */ new Map([[editor.languages.CodeActionTriggerType.Invoke, CodeActionTriggerKind.Invoked], [editor.languages.CodeActionTriggerType.Auto, CodeActionTriggerKind.Automatic]]);
  ...
  const lspCompletionItemKindToMonacoCompletionItemKind = /* @__PURE__ */ new Map([
    [CompletionItemKind.Text, editor.languages.CompletionItemKind.Text],
    [CompletionItemKind.Method, editor.languages.CompletionItemKind.Method],
    [CompletionItemKind.Function, editor.languages.CompletionItemKind.Function],
    [CompletionItemKind.Constructor, editor.languages.CompletionItemKind.Constructor],
    [CompletionItemKind.Field, editor.languages.CompletionItemKind.Field],
    [CompletionItemKind.Variable, editor.languages.CompletionItemKind.Variable],
    [CompletionItemKind.Class, editor.languages.CompletionItemKind.Class],
    [CompletionItemKind.Interface, editor.languages.CompletionItemKind.Interface],
    [CompletionItemKind.Module, editor.languages.CompletionItemKind.Module],
    [CompletionItemKind.Property, editor.languages.CompletionItemKind.Property],
    [CompletionItemKind.Unit, editor.languages.CompletionItemKind.Unit],
    [CompletionItemKind.Value, editor.languages.CompletionItemKind.Value],
    [CompletionItemKind.Enum, editor.languages.CompletionItemKind.Enum],
    [CompletionItemKind.Keyword, editor.languages.CompletionItemKind.Keyword],
    [CompletionItemKind.Snippet, editor.languages.CompletionItemKind.Snippet],
    [CompletionItemKind.Color, editor.languages.CompletionItemKind.Color],
    [CompletionItemKind.File, editor.languages.CompletionItemKind.File],
    [CompletionItemKind.Reference, editor.languages.CompletionItemKind.Reference],
    [CompletionItemKind.Folder, editor.languages.CompletionItemKind.Folder],
    [CompletionItemKind.EnumMember, editor.languages.CompletionItemKind.EnumMember],
    [CompletionItemKind.Constant, editor.languages.CompletionItemKind.Constant],
    [CompletionItemKind.Struct, editor.languages.CompletionItemKind.Struct],
    [CompletionItemKind.Event, editor.languages.CompletionItemKind.Event],
    [CompletionItemKind.Operator, editor.languages.CompletionItemKind.Operator],
    [CompletionItemKind.TypeParameter, editor.languages.CompletionItemKind.TypeParameter]
  ]);
  function toMonacoCompletionItemKind(kind) {
    if (!kind) return editor.languages.CompletionItemKind.Text;
    return lspCompletionItemKindToMonacoCompletionItemKind.get(kind) ?? editor.languages.CompletionItemKind.Text;
  }
  const lspCompletionItemTagToMonacoCompletionItemTag = /* @__PURE__ */ new Map([[CompletionItemTag.Deprecated, editor.languages.CompletionItemTag.Deprecated]]);
  ...
  const monacoCompletionTriggerKindToLspCompletionTriggerKind = /* @__PURE__ */ new Map([
    [editor.languages.CompletionTriggerKind.Invoke, CompletionTriggerKind.Invoked],
    [editor.languages.CompletionTriggerKind.TriggerCharacter, CompletionTriggerKind.TriggerCharacter],
    [editor.languages.CompletionTriggerKind.TriggerForIncompleteCompletions, CompletionTriggerKind.TriggerForIncompleteCompletions]
  ]);
  ...
  const lspInsertTextFormatToMonacoInsertTextRules = /* @__PURE__ */ new Map([[InsertTextFormat.Snippet, editor.languages.CompletionItemInsertTextRule.InsertAsSnippet]]);
  ...
  const lspSymbolKindToMonacoSymbolKind = /* @__PURE__ */ new Map([
    [SymbolKind.File, editor.languages.SymbolKind.File],
    [SymbolKind.Module, editor.languages.SymbolKind.Module],
    [SymbolKind.Namespace, editor.languages.SymbolKind.Namespace],
    [SymbolKind.Package, editor.languages.SymbolKind.Package],
    [SymbolKind.Class, editor.languages.SymbolKind.Class],
    [SymbolKind.Method, editor.languages.SymbolKind.Method],
    [SymbolKind.Property, editor.languages.SymbolKind.Property],
    [SymbolKind.Field, editor.languages.SymbolKind.Field],
    [SymbolKind.Constructor, editor.languages.SymbolKind.Constructor],
    [SymbolKind.Enum, editor.languages.SymbolKind.Enum],
    [SymbolKind.Interface, editor.languages.SymbolKind.Interface],
    [SymbolKind.Function, editor.languages.SymbolKind.Function],
    [SymbolKind.Variable, editor.languages.SymbolKind.Variable],
    [SymbolKind.Constant, editor.languages.SymbolKind.Constant],
    [SymbolKind.String, editor.languages.SymbolKind.String],
    [SymbolKind.Number, editor.languages.SymbolKind.Number],
    [SymbolKind.Boolean, editor.languages.SymbolKind.Boolean],
    [SymbolKind.Array, editor.languages.SymbolKind.Array],
    [SymbolKind.Object, editor.languages.SymbolKind.Object],
    [SymbolKind.Key, editor.languages.SymbolKind.Key],
    [SymbolKind.Null, editor.languages.SymbolKind.Null],
    [SymbolKind.EnumMember, editor.languages.SymbolKind.EnumMember],
    [SymbolKind.Struct, editor.languages.SymbolKind.Struct],
    [SymbolKind.Event, editor.languages.SymbolKind.Event],
    [SymbolKind.Operator, editor.languages.SymbolKind.Operator],
    [SymbolKind.TypeParameter, editor.languages.SymbolKind.TypeParameter]
  ]);
  function toMonacoSymbolKind(kind) {
    return lspSymbolKindToMonacoSymbolKind.get(kind) ?? editor.languages.SymbolKind.File;
  }
  const lspSymbolTagToMonacoSymbolTag = /* @__PURE__ */ new Map([[SymbolTag.Deprecated, editor.languages.SymbolTag.Deprecated]]);
  ...
  const lspDocumentHighlightKindToMonacoDocumentHighlightKind = /* @__PURE__ */ new Map([
    [DocumentHighlightKind.Text, editor.languages.DocumentHighlightKind.Text],
    [DocumentHighlightKind.Read, editor.languages.DocumentHighlightKind.Read],
    [DocumentHighlightKind.Write, editor.languages.DocumentHighlightKind.Write]
  ]);
  function toMonacoDocumentHighlightKind(kind) {
    if (!kind) return editor.languages.DocumentHighlightKind.Text;
    return lspDocumentHighlightKindToMonacoDocumentHighlightKind.get(kind) ?? editor.languages.DocumentHighlightKind.Text;
  }
  const lspFoldingRangeKindToMonacoFoldingRangeKind = /* @__PURE__ */ new Map([
    [FoldingRangeKind.Comment, editor.languages.FoldingRangeKind.Comment],
    [FoldingRangeKind.Imports, editor.languages.FoldingRangeKind.Imports],
    [FoldingRangeKind.Region, editor.languages.FoldingRangeKind.Region]
  ]);
  ...
  const monacoMarkerSeverityToLspDiagnosticSeverity = /* @__PURE__ */ new Map([
    [editor.MarkerSeverity.Error, DiagnosticSeverity.Error],
    [editor.MarkerSeverity.Warning, DiagnosticSeverity.Warning],
    [editor.MarkerSeverity.Info, DiagnosticSeverity.Information],
    [editor.MarkerSeverity.Hint, DiagnosticSeverity.Hint]
  ]);
  ...
  const lspDiagnosticSeverityToMonacoMarkerSeverity = /* @__PURE__ */ new Map([
    [DiagnosticSeverity.Error, editor.MarkerSeverity.Error],
    [DiagnosticSeverity.Warning, editor.MarkerSeverity.Warning],
    [DiagnosticSeverity.Information, editor.MarkerSeverity.Info],
    [DiagnosticSeverity.Hint, editor.MarkerSeverity.Hint]
  ]);
  function toMonacoDiagnosticSeverity(severity) {
    if (!severity) return editor.MarkerSeverity.Error;
    return lspDiagnosticSeverityToMonacoMarkerSeverity.get(severity) ?? editor.MarkerSeverity.Error;
  }
  const lspDiagnosticTagToMonacoMarkerTag = /* @__PURE__ */ new Map([[DiagnosticTag.Unnecessary, editor.MarkerTag.Unnecessary], [DiagnosticTag.Deprecated, editor.MarkerTag.Deprecated]]);
  ...
  const monacoSignatureHelpTriggerKindToLspSignatureHelpTriggerKind = /* @__PURE__ */ new Map([
    [editor.languages.SignatureHelpTriggerKind.Invoke, SignatureHelpTriggerKind.Invoked],
    [editor.languages.SignatureHelpTriggerKind.TriggerCharacter, SignatureHelpTriggerKind.TriggerCharacter],
    [editor.languages.SignatureHelpTriggerKind.ContentChange, SignatureHelpTriggerKind.ContentChange]
  ]);
  ...
  const lspInlayHintKindToMonacoInlayHintKind = /* @__PURE__ */ new Map([[InlayHintKind.Type, editor.languages.InlayHintKind.Type], [InlayHintKind.Parameter, editor.languages.InlayHintKind.Parameter]]);
  function toMonacoInlayHintKind(kind) {
    if (!kind) return editor.languages.InlayHintKind.Type;
    return lspInlayHintKindToMonacoInlayHintKind.get(kind) ?? editor.languages.InlayHintKind.Type;
  }
  ...
  function toDiagnosticMarker(diagnostic) {
    ...
    if (diagnostic.relatedInformation) marker.relatedInformation = diagnostic.relatedInformation.map((info) => ({
      resource: editor.Uri.parse(info.location.uri),
  ...
  var LspCompletionFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCompletion, true, (capability) => {
        return editor.languages.registerCompletionItemProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCompletionProvider(this._connection, capability));
      }));
    }
  };
  ...
  function convertLspToMonacoCompletionItem(lspItem, bridge, translated, model, position) {
    ...
    if (!range) range = editor.Range.fromPositions(position, position);
    const item = {
      label: lspItem.label,
  ...
  var LspHoverFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentHover, true, (capability) => {
        return editor.languages.registerHoverProvider(toMonacoLanguageSelector(capability.documentSelector), new LspHoverProvider(this._connection, capability));
      }));
    }
  };
...
\`\`\`` };
  ...
  var LspSignatureHelpFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSignatureHelp, true, (capability) => {
        return editor.languages.registerSignatureHelpProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSignatureHelpProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDefinitionFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDefinition, true, (capability) => {
        return editor.languages.registerDefinitionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDefinitionProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDeclarationFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDeclaration, true, (capability) => {
        return editor.languages.registerDeclarationProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDeclarationProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspTypeDefinitionFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentTypeDefinition, true, (capability) => {
        return editor.languages.registerTypeDefinitionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspTypeDefinitionProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspImplementationFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentImplementation, true, (capability) => {
        return editor.languages.registerImplementationProvider(toMonacoLanguageSelector(capability.documentSelector), new LspImplementationProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspReferencesFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentReferences, true, (capability) => {
        return editor.languages.registerReferenceProvider(toMonacoLanguageSelector(capability.documentSelector), new LspReferenceProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDocumentHighlightFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentHighlight, true, (capability) => {
        return editor.languages.registerDocumentHighlightProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentHighlightProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDocumentSymbolFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentSymbol, true, (capability) => {
        return editor.languages.registerDocumentSymbolProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentSymbolProvider(this._connection, capability));
      }));
    }
  };
  var LspDocumentSymbolProvider = class {
    ...
    async provideDocumentSymbols(model, token) {
      const translated = this._client.bridge.translate(model, new editor.Position(1, 1));
  ...
  var LspRenameFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentRename, true, (capability) => {
        return editor.languages.registerRenameProvider(toMonacoLanguageSelector(capability.documentSelector), new LspRenameProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspCodeActionFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCodeAction, true, (capability) => {
        return editor.languages.registerCodeActionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCodeActionProvider(this._connection, capability));
      }));
    }
  };
      ...
      const result = await this._client.server.textDocumentCodeAction({
        ...
        context: {
          diagnostics: context.markers.map((marker) => ({
            range: this._client.bridge.translateRange(model, editor.Range.lift(marker)),
  ...
  var LspCodeLensFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCodeLens, true, (capability) => {
        return editor.languages.registerCodeLensProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCodeLensProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDocumentLinkFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentLink, true, (capability) => {
        return editor.languages.registerLinkProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentLinkProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspFormattingFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentFormatting, true, (capability) => {
        return editor.languages.registerDocumentFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentFormattingProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspRangeFormattingFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentRangeFormatting, true, (capability) => {
        return editor.languages.registerDocumentRangeFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentRangeFormattingProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspOnTypeFormattingFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentOnTypeFormatting, true, (capability) => {
        return editor.languages.registerOnTypeFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspOnTypeFormattingProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspFoldingRangeFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentFoldingRange, true, (capability) => {
        return editor.languages.registerFoldingRangeProvider(toMonacoLanguageSelector(capability.documentSelector), new LspFoldingRangeProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspSelectionRangeFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSelectionRange, true, (capability) => {
        return editor.languages.registerSelectionRangeProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSelectionRangeProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspInlayHintsFeature = class extends Disposable {
    ...
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentInlayHint, true, (capability) => {
        ...
        const disposable = editor.languages.registerInlayHintsProvider(toMonacoLanguageSelector(capability.documentSelector), provider);
        return { dispose: () => {
  ...
  var LspInlayHintsProvider = class {
    _onDidChangeInlayHints = new editor.Emitter();
  ...
  function toLspInlayHintLabel(label) {
    ...
    return label.map((part) => {
      ...
      if (part.location) monacoLabelPart.location = {
        uri: editor.Uri.parse(part.location.uri),
        range: new editor.Range(part.location.range.start.line + 1, part.location.range.start.character + 1, part.location.range.end.line + 1, part.location.range.end.character + 1)
      };
  ...
  var LspSemanticTokensFeature = class extends Disposable {
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSemanticTokensFull, true, (capability) => {
        return editor.languages.registerDocumentSemanticTokensProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSemanticTokensProvider(this._connection, capability));
      }));
    }
  };
  ...
  var LspDiagnosticsFeature = class extends Disposable {
    ...
    constructor(_connection) {
      ...
      this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDiagnostic, true, (capability) => {
        ...
        for (const model of editor.editor.getModels()) this._addPullDiagnosticProvider(model, capability, disposables);
        disposables.add(editor.editor.onDidCreateModel((model) => {
    ...
    _handlePublishDiagnostics(params) {
      ...
      try {
        ...
        editor.editor.setModelMarkers(model, this._diagnosticsMarkerOwner, markers);
      } catch (error) {
  ...
  var ModelDiagnosticProvider = class extends Disposable {
    ...
    async _requestDiagnostics() {
      ...
      try {
        const translated = this._connection.bridge.translate(this._model, new editor.Position(1, 1));
    ...
    _handleDiagnosticReport(report) {
      if (report.kind === "full") {
        ...
        editor.editor.setModelMarkers(this._model, this._markerOwner, markers);
    ...
    _handleRelatedDocuments(relatedDocuments) {
      for (const [uri, report] of Object.entries(relatedDocuments)) try {
        ...
        if (report.kind === "full") {
          const markers = report.items.map((diagnostic) => toDiagnosticMarker(diagnostic));
          editor.editor.setModelMarkers(model, this._markerOwner, markers);
        }
      } catch (error) {
  ...
  var TextDocumentSynchronizer = class extends Disposable {
    ...
    constructor(_server, _capabilities) {
      ...
      this._register(_capabilities.registerCapabilityHandler(capabilities.textDocumentDidChange, true, (e) => {
        ...
        this._started = true;
        this._register(editor.editor.onDidCreateModel((m) => {
          this._getOrCreateManagedModel(m);
        }));
        for (const m of editor.editor.getModels()) this._getOrCreateManagedModel(m);
        return { dispose: () => {
        } };
      }));
    }
    ...
    translateBack(textDocument, position) {
      ...
      return {
        textModel,
        position: new editor.Position(position.line + 1, position.character + 1)
      };
    }
    translateBackRange(textDocument, range) {
      ...
      return {
        textModel,
        range: new editor.Range(range.start.line + 1, range.start.character + 1, range.end.line + 1, range.end.character + 1)
      };
    }
  ...
  if (!toggleHighContrast.FindWidget[tabIndexPatchKey]) {
    const originalReveal = toggleHighContrast.FindWidget.prototype._reveal;
    const originalHide = toggleHighContrast.FindWidget.prototype._hide;
    toggleHighContrast.FindWidget.prototype._reveal = function(...args) {
      originalReveal.apply(this, args);
      setFindWidgetTabbableState(this, true);
    };
    toggleHighContrast.FindWidget.prototype._hide = function(...args) {
      originalHide.apply(this, args);
      setFindWidgetTabbableState(this, false);
    };
    toggleHighContrast.FindWidget[tabIndexPatchKey] = true;
  }
  const monaco = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    CancellationTokenSource: editor.CancellationTokenSource,
    Emitter: editor.Emitter,
    KeyCode: editor.KeyCode,
    KeyMod: editor.KeyMod,
    MarkerSeverity: editor.MarkerSeverity,
    MarkerTag: editor.MarkerTag,
    ...
    Token: editor.Token,
    Uri: editor.Uri,
    css: src_deprecated_language_css_monaco_contribution_ts.register,
    editor: editor.editor,
    html: src_deprecated_language_html_monaco_contribution_ts.register,
    json: src_deprecated_language_json_monaco_contribution_ts.register,
    languages: editor.languages,
    lsp: index,
    typescript: src_deprecated_language_typescript_monaco_contribution_ts.register
  }, Symbol.toStringTag, { value: "Module" }));
  exports.index = index;
