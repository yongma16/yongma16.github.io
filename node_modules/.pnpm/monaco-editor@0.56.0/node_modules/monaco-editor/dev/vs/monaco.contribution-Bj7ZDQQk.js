define("vs/monaco.contribution-Bj7ZDQQk", ["require", "exports", "./editor-ECyZhXSU"], (function(require, exports, editor) {
  "use strict";
  ...
  class LanguageServiceDefaultsImpl {
    constructor(compilerOptions, diagnosticsOptions, workerOptions, inlayHintsOptions, modeConfiguration) {
      ...
      this._onDidExtraLibsChange = new editor.Emitter();
  ...
  function getMode() {
    return new Promise((resolve, reject) => require(["./tsMode-BWLDZXKb"], resolve, reject));
  }
  editor.languages.onLanguage("typescript", () => {
    return getMode().then((mode) => mode.setupTypeScript(typescriptDefaults));
  });
  editor.languages.onLanguage("javascript", () => {
