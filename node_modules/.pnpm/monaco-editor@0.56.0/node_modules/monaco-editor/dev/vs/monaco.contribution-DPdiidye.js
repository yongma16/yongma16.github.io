define("vs/monaco.contribution-DPdiidye", ["require", "exports", "./editor-ECyZhXSU"], (function(require, exports, editor) {
  "use strict";
  ...
  function getMode() {
    return new Promise((resolve, reject) => require(["./htmlMode-CIuYTVRb"], resolve, reject));
  }
  function registerHTMLLanguageService(languageId, options = optionsDefault, modeConfiguration = getConfigurationDefault(languageId)) {
    const defaults = new LanguageServiceDefaultsImpl(languageId, options, modeConfiguration);
    let mode2;
    const onLanguageListener = editor.languages.onLanguage(languageId, async () => {
