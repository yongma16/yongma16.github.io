...
async function test() {
    ...
    const email1 = JSON.parse(result1.content[0].text);
    ...
    const email2 = JSON.parse(result2.content[0].text);
    ...
    const email3 = JSON.parse(result3.content[0].text);
    ...
    const email4 = JSON.parse(result4.content[0].text);
    ...
    const email5 = JSON.parse(result5.content[0].text);
    ...
    const email6 = JSON.parse(result6.content[0].text);
    ...
    const email7 = JSON.parse(result7.content[0].text);
    ...
    const email8 = JSON.parse(result8.content[0].text);
    ...
    const email9 = JSON.parse(result9.content[0].text);
